...
//==============================================================================
// UI 노드.
// - AnchoredTransformNode를 기반으로 UI 전용 기능을 추가한다.
// - 마스크: 자식이 자신의 contentSize 영역 밖으로 나가면 크롭한다.
// - 이벤트 체이닝: 자식 UINode에 터치 이벤트 수신 순서를 보장한다.
//   나중에 그려진 자식이 먼저 이벤트를 수신하며, 소비하면 앞 자식에게 전달되지 않는다.
// - 포커스: 자신부터 가장 상위의 UINode까지 포커스 상태를 전파한다.
//==============================================================================
