...
export class DEVTools extends Object {
	...
	drawLocalStoragePanel(graphic, panelX, panelY, panelWidth, panelHeight) {
		...
		graphic.setTextAlign("center");
		graphic.drawFillText("×", panelX + panelWidth - SCROLL_BAR_WIDTH - delColWidth * 0.5, columnHeaderY + ITEM_HEIGHT * 0.5);
		...
		for (let keyIndex = 0; keyIndex < keys.length; ++keyIndex) {
			...
			graphic.setFontString(`${FONT_SIZE}px monospace`);
			graphic.setTextAlign("center");
			graphic.drawFillText("×", delBtnX + delColWidth * 0.5, itemMidY);
		}
