//==============================================================================
// 비주얼 에디터 단일 HTML 빌드. (서버 없이 file:// 로 바로 실행 가능한 한 파일)
// - 실행: node tools/visualeditor/build.mjs
//==============================================================================
...
const bundlePath = join(scriptDirectory, "visualeditor.bundle.js");
const outputPath = join(scriptDirectory, "visualeditor.html");

// 편집기 + 엔진을 IIFE 로 번들. (file:// 에서는 ES 모듈 import 가 막히므로 인라인이 필요)
execFileSync("esbuild", [
	join(scriptDirectory, "visualeditor.js"),
	"--bundle",
	`--outfile=${bundlePath}`,
	"--format=iife",
	"--keep-names",
...
<head>
<meta charset="utf-8">
<title>vanilla.js - Visual Editor</title>
